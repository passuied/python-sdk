...
from dapr.ext.workflow.aio.workflow_runtime import WorkflowRuntime
from dapr.ext.workflow.dapr_workflow_context import DaprWorkflowContext
from dapr.ext.workflow.workflow_activity_context import WorkflowActivityContext
from dapr.ext.workflow.workflow_runtime import alternate_name
...
class WorkflowRuntimeTest(unittest.TestCase):
    def setUp(self):
        ...
        self.runtime_options = WorkflowRuntime(main_event_loop=asyncio.get_event_loop())
    ...
    async def mock_client_activity(ctx: WorkflowActivityContext, input):
